...
const JazzCafe = () => {
  ...
  const [activeUsers, setActiveUsers] = useState([
    { displayName: "JazzEnthusiast", id: "demo1" },
    { displayName: "SaxophonePlayer", id: "demo2" },
    { displayName: "MusicProducer", id: "demo3" }
  ]);
  ...
  useEffect(() => {
    ...
    const roomRef = doc(db, "rooms", "jazz-cafe");
  ...
  return (
    <div className="jazz-cafe-container">
      {/* ... existing code ... */}
